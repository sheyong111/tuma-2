...
export default function Contact(props) {
  ...
  const contactList = [
    ...
    {
      name: "Zhixiang Zuo", // 姓名
      siteUrl: "https://www.researchgate.net/profile/Zhixiang-Zuo", // 个人网站地址
      mail: "zuozhx@sysucc.org.cn", // 电子邮箱
  ...
  return (
    <div className="contact-wrap">
      <div className="tuma-theme-title-main" style={{ paddingBottom: "50px" }}>
        <ContactsOutlined />
        Contact
      </div>
